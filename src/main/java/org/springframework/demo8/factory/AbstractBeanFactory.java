...
import org.springframework.demo8.entity.*;
...
public abstract class AbstractBeanFactory extends DefaultSingletonBeanRegistry implements BeanFactory, BeanDefinitionRegistry {
    ...
    public Object getBean(String beanName) throws BeansException {
        ...
        if (singleton == null) {
            //如果没有实例，则尝试从毛胚实例中获取
            log.info("beanName = {} , no singleton", beanName);
            singleton = this.earlySingletonObjects.get(beanName);
            if (singleton == null) {
                //如果连毛胚都没有，则创建bean实例并注册
                log.info("beanName = {} , no earlySingletonObject", beanName);
    ...
    private Object doCreateBean(BeanDefinition beanDefinition) {
        ...
        log.info("doCreateBean for beanName = {}", beanDefinition.getId());
        try {
            clz = Class.forName(beanDefinition.getClassName());
            // handle constructor
    ...
    private void handleProperties(BeanDefinition beanDefinition, Class<?> clz, Object obj) {
        // handle properties
        log.info("handle properties for beanName = {}", beanDefinition.getId());
        ...
        log.info("handleProperties done, obj = {} ", obj);
    }
